...
const resellerNav = [
  { href: "/dashboard", label: "Dashboard", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" },
  { href: "/dashboard/keys", label: "Generate Keys", icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" },
];
      ...
      <aside className="w-[72px] lg:w-60 bg-[#111] border-r border-gray-800/50 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-800/50">
          <div className="flex items-center gap-2">
            ...
            <div className="hidden lg:block">
              ...
              <p className="text-[10px] text-gray-500">{user?.type === "reseller" ? "Revendedor" : "Admin"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-gray-800/50">
          <div className="flex items-center gap-2 mb-2 px-2">
            ...
            <span className="hidden lg:block text-xs text-gray-400 truncate">{user?.username}</span>
          </div>
          <button
